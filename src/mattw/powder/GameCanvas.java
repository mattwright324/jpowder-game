...
public class GameCanvas extends Canvas {
    ...
    public SimpleLongProperty fpsCap = new SimpleLongProperty(JPowder.DEFAULT_FPS_CAP);
    ...
    public GameCanvas() { this(JPowder.DEFAULT_WIDTH, JPowder.DEFAULT_HEIGHT); }
    ...
    private void setMousePoint(MouseEvent me) {
        ...
        mousePos = me;
        if(placeEl) {
            getEngine().drawAtPoint(this, mousePos, lastMouse, cursorSize, type);
        }
    }
    ...
    public void newEngine(int w, int h) {
        ...
        if(width() != w || height() != h) {
            ...
            engine.quit();
            engine = engine.copyStateToNewSize(w, h);
        }
    }
